...
(pls/defn-validated catalog-row-map
  ...
  [hash
   {:keys [api-version version transaction-uuid environment]} :- catalog-schema
...
(pls/defn-validated update-existing-facts!
...
(pls/defn-validated certname-facts-metadata!
