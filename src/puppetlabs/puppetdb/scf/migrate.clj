...
(defn store-latest-reports-separately
  ...
  (jdbc/do-commands
   ...
   ;; TODO no foreign key, just add GC logic for additional partition
  "ALTER TABLE reports_latest ADD CONSTRAINT reports_latest_certnames_fkey FOREIGN KEY (certname) REFERENCES certnames (certname) ON DELETE CASCADE"))
