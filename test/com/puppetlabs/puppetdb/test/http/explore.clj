(ns com.puppetlabs.puppetdb.test.http.explore
...
(deftest test-exploration
  (let [catalog (:basic catalogs)
    ...
    (scf-store/add-facts! "host1" facts1 (now) "DEV" nil)
    (scf-store/add-facts! "host2" facts2 (now) "DEV" nil)
    (scf-store/add-facts! "host3" facts3 (now) "DEV" nil)
