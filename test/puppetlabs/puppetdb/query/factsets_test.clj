...
(deftest test-structured-data-seq
  (let [test-rows [{:certname "foo.com" :environment "DEV" :path "a#~b#~c"
                    :value "abc" :type "string" :timestamp current-time :value-integer nil
                    :value-float nil :producer-timestamp current-time :hash "1234"}
                   {:certname "foo.com" :environment "DEV" :path "a#~b#~d"
                    :value nil :type "integer" :timestamp current-time
                    :value-integer 1 :value-float nil :producer-timestamp current-time :hash  "1234"}
                   {:certname "foo.com" :environment "DEV" :path "a#~b#~e"
                    :value "true" :type "boolean" :timestamp current-time
                    :value-integer nil :value-float nil :producer-timestamp current-time :hash "1234"}
                   {:certname "foo.com" :environment "DEV" :path "a#~b#~f"
                    :value-float 3.14 :type "float" :timestamp current-time
                    :value-integer nil :value nil :producer-timestamp current-time :hash "1234"}]]
    (is (= [{:certname "foo.com"
             :environment "DEV"
             :facts {"a" {"b" {"c" "abc"
                               "d" 1
                       ...
                       :v4 (mapcat
                             (fn [certname]
                               [{:certname certname :environment "DEV" :path "a#~b#~c"
                                 ...
                                 :value-integer nil :value-float nil
                                 :producer-timestamp current-time :hash "1234"}
                                {:certname certname :environment "DEV" :path "a#~b#~d"
                                 :value-integer 1 :type "integer" :timestamp current-time
                                 :value nil :value-float nil
                                 :producer-timestamp current-time :hash "1234"}
                                {:certname certname :environment "DEV" :path "a#~b#~e"
                                 :value-float 3.14 :type "float" :timestamp current-time
                                 :value-integer nil :value nil
                                 :producer-timestamp current-time :hash "1234"}
  ...
  (testing "map with a nested vector"
    (let [test-rows [{:certname "foo.com" :environment "DEV"
                     ...
                     {:certname "foo.com" :environment "DEV"
                      :path "a#~b#~d#~0" :value-integer 1 :type "integer" :timestamp current-time
                      :value nil :value-float nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV"
                      :path "a#~b#~d#~1" :value-integer 3 :type "integer" :timestamp current-time
                      :value nil :value-float nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV"
  ...
  (testing "map with a nested vector of maps"
    (let [test-rows [{:certname "foo.com" :environment "DEV" :path "a#~b#~c"
                     ...
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~d#~1#~e#~f#~0"
                      :value-integer 2 :type "integer" :timestamp current-time
                      :value nil :value-float nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~e"
  ...
  (testing "json numeric formats"
    (let [test-rows [{:certname "foo.com" :environment "DEV" :path "a#~b#~c"
                      :value-integer 100000000000 :type "integer" :timestamp current-time
                      :value nil :value-float nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~d#~\"0\"#~e#~f#~0"
                      :value-float 3.14E10 :type "float" :timestamp current-time
                      :value-integer nil :value nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~d#~\"1\"#~e#~f#~0"
                      :value-float 1.4e-5 :type "float" :timestamp current-time
                      :value-integer nil :value nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~e"
                      :value-float -10E-5 :type "float" :timestamp current-time
                      :value-integer nil :value nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~f"
                      :value-float -0.25e-5 :type "float" :timestamp current-time
                      :value-integer nil :value nil
                      :producer-timestamp current-time :hash "1234"}]]
      (is (= [{:certname "foo.com"
               :environment "DEV"
  ...
  (testing "map stringified integer keys"
    (let [test-rows [{:certname "foo.com" :environment "DEV" :path "a#~b#~c"
                     ...
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~d#~\"0\"#~e#~f#~0"
                      ...
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV"
                      :path "a#~b#~d#~\"1\"#~e#~f#~0" :value-integer 2 :type "integer"
                      :timestamp current-time :value nil :value-float nil
                      :producer-timestamp current-time :hash "1234"}
                     {:certname "foo.com" :environment "DEV" :path "a#~b#~e"
                      :value "abe" :type "string" :timestamp current-time
                      :value-integer nil :value-float nil
