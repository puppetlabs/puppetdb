---
title: "PuppetDB 3.1 » API » v4 » Querying Factsets"
layout: default
...
* [`environments`][environments]: Environment this factset was received from.
...
* [`nodes`][nodes]: Node that this factset was received from.
