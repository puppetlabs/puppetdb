...
Ubuntu Xenial - 16.04, adds preliminary sorry for HUP signal handling, and
...
* Preliminary support for HUP signal handling. Note that due to
  [AMQ-5263][https://issues.apache.org/jira/browse/AMQ-5263] there is a
  possibility of a crash when HUPed. We've observed this typically happens when
  HUPed under heavy load. This will be fixed and more robust in a future release
