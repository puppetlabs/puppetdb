...
time s3cmd --verbose --acl-public --delete-removed  sync ${REPO_DIR}/apt/{jessie,lucid,precise,squeeze,trusty,wheezy,wily,stable,testing} ${S3_BRANCH_PATH}/repos/apt/
